package com.terraboxstudios.instantreplay.versionspecific.v1_11_R1.blocks;
...
public class BlockChangeImpl extends BlockChange {
    ...
    public void send(Player player, Location location) {
        ...
        player.sendBlockChange(location, blockChangeDataRaw.getMaterial(), blockChangeDataRaw.getData());
    }
