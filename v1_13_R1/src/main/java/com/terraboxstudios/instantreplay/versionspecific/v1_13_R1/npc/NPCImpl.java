package com.terraboxstudios.instantreplay.versionspecific.v1_13_R1.npc;
...
public class NPCImpl extends NPC {
    ...
    public void setEquipmentSlot(int i, ItemStack item) {
        ...
        PlayerConnection connection = ((CraftPlayer) viewer).getHandle().playerConnection;
        connection.sendPacket(new PacketPlayOutEntityEquipment(entityPlayer.getId(), getItemSlotFromInt(i), nmsItemStack));
    }
